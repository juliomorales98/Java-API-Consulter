...
public class NewQuery extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("New Query");

        jLabel2.setText("API Url (without key)");
        ...
        jTextField1.getAccessibleContext().setAccessibleName("urlTextField");
        jLabel3.getAccessibleContext().setAccessibleName("keyTextField");
        consultButton.getAccessibleContext().setAccessibleName("consultButton");
